...
import pl.komorowskidev.solutions.problems.median.Median
...
class MedianTest extends Specification {
    ...
    def setup(){
        ...
        median = new Median(solutionsModelMock, linesProcessorMock, medianOddNumberOfElementsMock, medianEvenNumberOfElementsMock)
    }
